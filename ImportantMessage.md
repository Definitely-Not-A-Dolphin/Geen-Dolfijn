...
This project uses _deno_, not _npm_ to run it. There is a reason
`package.json.old` and `package-lock.json.old` are named that. Please install
...
There are two files concerning nix-users. If you do not use NixOS, just ignore
